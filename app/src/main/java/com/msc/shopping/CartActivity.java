...
import com.msc.shopping.Model.Cart;
import com.msc.shopping.Prevalent.CartViewHolder;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("Confirmed")){
                        txtTotalAmount.setText("TDear "+userName+"\n order has been Confirmed. Please Wait for Further Notice.");
                        ...
                        txtTotalAmount.setText("Order State = Not Confirmed");
                        recyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
